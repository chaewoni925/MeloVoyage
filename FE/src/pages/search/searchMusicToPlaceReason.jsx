        ...
        <div className="min-h-screen bg-gray-100 flex justify-center">
            <div className="w-full max-w-md bg-white min-h-screen relative">
                ...
                <div className="px-6 pb-8 pt-6">
                    ...
                    <p className="mt-1 text-sm font-medium text-violet-600">{place.intro}</p>

                    {/* AI 추천 이유 */}
                    <div className="mt-5 rounded-2xl border border-gray-100 bg-white p-5 shadow-[0_1px_8px_rgba(0,0,0,0.06)]">
