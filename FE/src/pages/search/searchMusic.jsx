            ...
            <div className="bg-white p-5 rounded-b-3xl w-full max-w-md relative">
                ...
                <section className="flex flex-col items-center mt-5">
                    ...
                    <div className="w-full px-2 relative flex items-center">
                        {/* 돋보기 아이콘 */}
                        <svg
                            className="absolute left-6 w-4 h-4 text-gray-400 pointer-events-none"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
                        ...
                        <input
                            ...
                            className="w-full border border-black bg-white text-sm text-600 placeholder-400 rounded-xl pl-11 pr-11 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400 transition-all"
                        />
                        {searchQuery && (
                            <button
                ...
                <section className="px-2">
                    ...
                    {/* 밑 동그라미 세개*/}
                    <div className="flex justify-center mt-[20px] items-center gap-3">

                        <svg className="dot1" width="22" height="22" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="11" cy="11" r="11" fill="#D9D9D9" /> </svg>

                        <svg className="dot2" width="22" height="22" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="11" cy="11" r="11" fill="#D9D9D9" /> </svg>


                        <svg className="dot3" width="22" height="22" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="11" cy="11" r="11" fill="#D9D9D9" /> </svg>
