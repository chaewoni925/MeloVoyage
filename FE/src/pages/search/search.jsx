...
const SearchPage = () => {
    ...
    return (
        ...
        <section className="flex flex-col items-center mt-[100px]">
                    {/* 박스 1: 장소로 음악 찾기 */}
                    <div className="cursor-pointer bg-[#D9D9D9] p-4 rounded-lg h-[300px] w-[350px] mt-8 overflow-hidden relative"
                    onClick={() => navigate('/searchPlaceToMusic')} >
                        ...
                        <div className="relative z-10 p-2">
                            <h1 className="text-[18px] font-bold text-white mb-2 mt-[180px]">장소로 음악 찾기</h1>
