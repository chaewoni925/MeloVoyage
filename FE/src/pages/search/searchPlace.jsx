        ...
        <div className="min-h-screen bg-gray-100 flex justify-center">
            <div className="bg-white p-6 rounded-b-3xl w-full max-w-md relative">
                ...
                <section className="flex flex-col  mt-[44px]">
                    <h1 className="text-[23px] font-bold mb-4 "> 어떤 장소에 가고 싶나요?</h1>
                ...
                <section className="flex flex-col items-center mt-11">
                    ...
                    <div className="w-full relative flex items-center">
                        ...
                        <input
                            ...
                            placeholder="검색"
                            className="w-full border border-black bg-white text-sm text-600 placeholder-400 rounded-xl pl-11 pr-10 py-5 focus:outline-none focus:ring-2 focus:ring-purple-400 transition-all"
                        />
                        {searchQuery && (
                            <button
                ...
                {/*최근 여행지*/}
                <section>
                    <h1 className="text-purple-600 text-[15px] font-bold mt-[45px] mb-4">
                        최근 여행지 </h1>
                    <div className="flex gap-5 overflow-x-auto snap-x snap-mandatory no-scrollbar ">
                        <div className="cursor-pointer bg-[#D9D9D9] p-4 rounded-lg w-[90px] h-[10px] "></div>
                        <div className="cursor-pointer bg-[#D9D9D9] p-4 rounded-lg w-[90px] h-[10px] "></div>
                        <div className="cursor-pointer bg-[#D9D9D9] p-4 rounded-lg w-[90px] h-[10px] "></div>
                        <div className="cursor-pointer bg-[#D9D9D9] p-4 rounded-lg w-[90px] h-[10px] "></div>
                    </div>
